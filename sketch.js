...
//Number of Iterations, when it reaches lifespan then the current generation is over.
var count = 0;
...
//Exponential Multiplier for Distance (The closer the Rocket is the more Fitness it gets exponentially)
...
function draw() {
    ...
    if(count == (lifespan / speedMultiplier)){
        ...
        avgFitP.html('AVG Fitness: ' + population.avgfit/popCount);
				popStatsP.html('Population: ' + popCount + ' Target reached: ' + targetReachedCount + ' (' + round(((targetReachedCount / popCount)*100)) + '%)');
...
function Population(){
    ...
    this.evaluate = function(){
        ...
        for(var i = 0; i < this.popsize; i++){
            ...
            //Selection for the Mating pool, 
						//the higher the Fitness of a Rocket the more often it is in the matingpool
    ...
    this.selection = function(){
        ...
        //Chooses parentA and parentB to create new Rockets based on the Matingpool through crossover
